...
vcf_path <- "C:/Users/alec1/Desktop/CWDProject/Objective.One_60Kvs.600K_Relatedness/Scripts/Final_Scripts/List.for.Google.Doc/600.Individual.loci/Random600.pilot.vcf"
# Read the VCF file
...
file_path <- "C:/Users/alec1/Desktop/CWDProject/Objective.One_60Kvs.600K_Relatedness/Scripts/Final_Scripts/List.for.Google.Doc/600.Individual.loci/COLONY/error.rate"
...
#replace 1 with 2...
OffspringC[,c(2:601)] <- data.frame(lapply(OffspringC[,c(2:601)], function(x) {
  gsub("1", "2", x)}))
# ...and 0 with 1
OffspringC[,c(2:601)] <- data.frame(lapply(OffspringC[,c(2:601)], function(x) {
  gsub("0", "1", x)}))  
...
file_path <- "C:/Users/alec1/Desktop/CWDProject/Objective.One_60Kvs.600K_Relatedness/Scripts/Final_Scripts/List.for.Google.Doc/600.Individual.loci/colony.offspring.input"
## Export the data frame to a text file
#save as tab delim
...
maleadults[,c(2:601)] <- data.frame(lapply(maleadults[,c(2:601)], function(x) {
  gsub("1", "2", x)}))
# ...and 0 with 1
maleadults[,c(2:601)] <- data.frame(lapply(maleadults[,c(2:601)], function(x) {
  gsub("0", "1", x)}))  
...
# Export the data frame to a text file
file_path <- "C:/Users/alec1/Desktop/CWDProject/Objective.One_60Kvs.600K_Relatedness/Scripts/Final_Scripts/List.for.Google.Doc/600.Individual.loci/male.adults.input"
...
femaleadults[,c(2:601)] <- data.frame(lapply(femaleadults[,c(2:601)], function(x) {
  gsub("1", "2", x)}))
# ...and 0 with 1
femaleadults[,c(2:601)] <- data.frame(lapply(femaleadults[,c(2:601)], function(x) {
  gsub("0", "1", x)}))  
...
file_path <- "C:/Users/alec1/Desktop/CWDProject/Objective.One_60Kvs.600K_Relatedness/Scripts/Final_Scripts/List.for.Google.Doc/600.Individual.loci/female.adults.input"
# Export the data frame to a text file
...
file_path <- "C:/Users/alec1/Desktop/CWDProject/Objective.One_60Kvs.600K_Relatedness/Scripts/Final_Scripts/List.for.Google.Doc/600.Individual.loci/female.adults.input.plusMN164234"
# Export the data frame to a text file
write.table(femaleadults, file = file_path, sep = "\t", row.names = FALSE, col.names = FALSE, quote=FALSE)

file_path <- "C:/Users/alec1/Desktop/CWDProject/Objective.One_60Kvs.600K_Relatedness/Scripts/Final_Scripts/List.for.Google.Doc/600.Individual.loci/colony.offspring.input.minusMN164234"
## Export the data frame to a text file
#save as tab delim
write.table(OffspringC, file = file_path, sep = "\t", row.names = FALSE, col.names = FALSE, quote=FALSE)